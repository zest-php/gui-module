 ...
 */
class Gui_WidgetTest extends Gui_AbstractTest{
	...
	protected function setUp(){
		parent::setUp();
		$this->_widget = new Ns_WidgetTest_Widget_Special();
	}
	...
	public function testRender(){
		...
		$this->assertContains('$("#ns-widgettest-widget-special").special({});', $render);
	}
	
	public function testGetJqueryIdSelector(){
		$this->assertEquals('ns-widgettest-widget-special', $this->_widget->getJqueryIdSelector());
	}
...
class Gui_WidgetTest_Widget extends Gui_Widget{
}

class Ns_WidgetTest_Widget_Special extends Gui_Widget{
